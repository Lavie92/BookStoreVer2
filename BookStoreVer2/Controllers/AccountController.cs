...
namespace BookStoreVer2.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            // Đăng nhập với "Tên đăng nhập (Username)" hoặc "Email"
            ...
            //var result = user == null ? SignInStatus.Failure : await SignInManager.PasswordSignInAsync(model.Email, model.Password, model.RememberMe, shouldLockout: false);
